        ...
        <form action="{{ route('estudiante.Avance_horas') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="campo-formulario">
                ...
                <input type="number" class="form-control" id="horasTrabajadas" name="horasTrabajadas"
                    ...
                    max="{{$proyecto->horas_requeridas - $horas->horas_sociales_completadas}}" required>
            ...
            <div class="campo-formulario">
                <p>Progreso actual: <strong> {{ $horas->horas_sociales_completadas }} de
                        {{ $proyecto->horas_requeridas }} horas</strong></p>
                        <input type="text" name="horas_requeridas" value="{{ $proyecto->horas_requeridas - $horas->horas_sociales_completadas }}">
                        </div>
            ...
            <div class="d-flex justify-content-between">
                <a href="{{route('proyectomio')}}" class="btn boton-secundario">Volver al proyecto</a>
